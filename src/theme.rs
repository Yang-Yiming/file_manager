...
impl ModernTheme {
    ...
    fn zed_light_theme() -> egui::Visuals {
        ...
        visuals.widgets.noninteractive.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(225, 225, 225));
        
        visuals.widgets.inactive.bg_fill = egui::Color32::from_rgb(240, 240, 240);
        visuals.widgets.inactive.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(220, 220, 220));
        
        visuals.widgets.hovered.bg_fill = egui::Color32::from_rgb(235, 235, 235);
        visuals.widgets.hovered.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(210, 210, 210));
        
        visuals.widgets.active.bg_fill = egui::Color32::from_rgb(230, 230, 230);
        visuals.widgets.active.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(200, 200, 200));
    ...
    fn zed_dark_theme() -> egui::Visuals {
        ...
        visuals.widgets.noninteractive.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(45, 45, 45));
        ...
        visuals.widgets.hovered.bg_stroke = egui::Stroke::new(1.0, egui::Color32::from_rgb(60, 60, 60));
